...
def plot_learning_curve(clf, X, y, scoring='accuracy', training_set_size=5, cv=5, x_min=0, x_max=500, y_min=0.3,
                        y_max=1.02, title='', leg_loc=4):
    '''
    ...
    train_size, train_scores, valid_scores = learning_curve(clf, X, y, cv=cv, random_state=42,
