...
ml_5_to10_svm, x5_to10_train, x5_to10_test, y5_to10_train, y5_to10_test = svm_train(df_ml_5_dropto10,
                                                                                    print_result=False)
...
# in this section we will take the learnings from the hyperparameter testing above and train a final model using 100%
# of the data. This model may then be used for predictions going forward.

if create_final_model:
    # instantiating and training the df_5 network
    ml_5_svm = svm.SVC(kernel='rbf', C=3, probability=True)
    ml_5_svm.fit(x_5, y_5)

    # instantiating and training the df_10 network
