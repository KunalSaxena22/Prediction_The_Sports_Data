...
teams_df = teams_df.drop \
    (['Fixture ID', 'Game Date', 'Away Team', 'Away Team ID', 'Home Team Goals', 'Away Team Goals', 'Away Team Logo'],
     axis=1)
...
for team in teams:
    ...
    df = pd.DataFrame \
        (columns=['Fixture_ID', 'Date', 'Home_Team_ID', 'Away_Team_ID', 'Home_Team', 'Away_Team', 'Home_Team_Score'
            , 'Away_Team_Score', 'Result', 'Home_Team_Logo', 'Away_Team_Logo'])
